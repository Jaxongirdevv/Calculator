...
public class MainActivity extends AppCompatActivity {
    ...
    button8,button9,buttonadd,buttonmultplay,buttonsubs,buttondivision,buttonpoint,buttonprecent,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonmultplay=findViewById(R.id.multiplay_btn);
        ...
        buttonprecent=findViewById(R.id.percent_btn);
